...
var I18N = (function () {
  ...
  var EN = {
    ...
    "Comece como a pior seleção da Copa e transforme o time treinando jogadores e comprando reforços com as fichas que ganhar jogando. Sua campanha fica salva sozinha neste navegador.":
      "Start as the worst nation in the World Cup and rebuild the team by training players and buying reinforcements with the tokens you earn. Your campaign saves itself in this browser.",
    "Começar campanha": "Start campaign",
    "Continuar campanha": "Continue campaign",
    "Começar de novo": "Start over",
    "Isso apaga a campanha salva, com elenco, fichas e reforços. Começar de novo?":
      "This erases the saved campaign — squad, tokens and reinforcements. Start over?",
    "LOJA DO PUERTO MALTA": "PUERTO MALTA SHOP",
    ...
    "{0} assinou com o Puerto Malta!": "{0} signed for Puerto Malta!",
    ...
    "Gana": "Ghana",
    "Paraguai": "Paraguay",
    "Puerto Malta": "Puerto Malta",

    /* ---------- uniformes (campo `kit`: so o apelido; as siglas de
       federacao sairam em 2026-09-02 por serem marcas reais) ---------- */
    "Amarelo-Canarinho": "Canary Yellow",
    "Preto & Ouro": "Black & Gold",
    "Azul Blues": "Les Bleus Blue",
    "Albiceleste": "Albiceleste",
    "Azzurri": "Azzurri",
    "Fúria Vermelha": "Red Fury",
    "Amarela Cafetera": "Coffee Yellow",
    "Xadrez Vermelho": "Red Chequers",
    "Laranja Mecânica": "Clockwork Orange",
    "Verde Azteca": "Aztec Green",
    "Vikings do Gelo": "Vikings of the Ice",
    "Vermelho e Verde": "Red and Green",
    "Três Leões": "Three Lions",
    "Garra Charrúa": "Charrúa Grit",
    "Guerreiros Taeguk": "Taeguk Warriors",
    "Diabos Vermelhos": "Red Devils",
    "La Roja": "La Roja",
    "Samurai Blue": "Samurai Blue",
    "Leões do Atlas": "Atlas Lions",
    "Leões da Savana": "Savanna Lions",
    "Ouro e Verde": "Gold and Green",
    "Estrelas e Barras": "Stars and Stripes",
    "Águias Verdes": "Green Eagles",
    "Vermelho e Azul": "Red and Blue",
    "Leões da Pérsia": "Lions of Persia",
    "Falcões Verdes": "Green Falcons",
    "Azul e Amarelo": "Blue and Yellow",
    "Dinamite Vermelha": "Red Dynamite",
    "Vermelhos dos Alpes": "Reds of the Alps",
    "Leões do Oeste": "Lions of the West",
    "Estrelas do Golfo": "Stars of the Gulf",
    "Garra Guarani": "Guarani Grit",
    "Zebra da Copa": "Cup Underdogs"
  };
